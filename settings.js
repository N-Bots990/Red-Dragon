...
global.alivemsg = `╭─────────────❥ 
┃ 🔥 𝐍𝐈𝐏𝐔-𝐌𝐃 *𝐁ot 𝐢s 𝐎nline!* 🔥 
┃ 
┃ 🤖 *𝐘our 𝐒mart 𝐀ssistant, 𝐀lways 𝐇ere 𝐟or 𝐘ou!* 
┃ 
→→→→→→→→→→→→→→→
> 𝐌𝐲 𝐂𝐡𝐚𝐧𝐧𝐞𝐥 : https://whatsapp.com/channel/0029Vb9bLMqGJP8GmAHxUd02
→→→→→→→→→→→→→→→
┃ 🛠 *𝐅eatures I 𝐏rovide:* 
┃ ┃ 📂 Automated Replies 
┃ ┃ 🔍 Information Retrieval 
┃ ┃ 🎨 Fun & Games 
┃ ┃ 🤖 Chat with AI (ᴄʜᴀᴛ_ɢᴘᴛ) 
┃ 
┃ 📌 *𝐂ommands 𝐘ou 𝐂an 𝐓ry:* 
┃ ┃ `.menu` - See all options 
┃ ┃ `.list` - Explore available features 
┃ ┃ `.gpt` - Ask me anything with AI! 
┃ ┃ `.ping` - Check my status 
┃ 
┃ 🚀 *𝐔ptime:* Always Ready for Action! 
┃ 🌐 *𝐏owered by* 𝐍𝐈𝐏𝐔-𝐌𝐃 *𝐒ystem* 
╰─────────────❥ 

*🔗 𝐋et’s make every chat fun and productive! 🌟*` //Costomize Alive Message (type your message in `` )
...
//owner v card
global.vcardowner = ['+94729007640'] // owner number
global.ownername = "𝐌𝐫_𝐍𝐈𝐏𝐔𝐍❤❯❯" // owner name
global.ytname = "N-TechHub" // yt chanel name
global.socialm = "GitHub: N-Bots990" // github or insta name
...
global.owner = ['+94729007640']
global.ownertag = '+94729007640' //your tag number
global.botname = '𝙍𝙀𝘿╺ 𝘿𝙍𝘼𝙂𝙊𝙉 - 𝘉𝘖𝘛' //ur bot name
global.packname = "Bot Sticker" // sticker packname
global.author = "͢ᴿᴱᴬᴸ̮̮׀N I P͛͢ U N ͎͎͛͛͛͌ˣˣˣ" // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = '[ ◉ ʀᴇᴅ-ᴅʀᴀɢᴏɴ-ᴍᴅ ]' //

//database
global.premium = ['+94729007640'] //ur premium numbers

//other
global.sessionName = 'NIPUN'
